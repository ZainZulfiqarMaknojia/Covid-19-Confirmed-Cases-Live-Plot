...
CountriesName = ['US','Brazil','Russia','United Kingdom','Spain','Italy','France','Germany',
                    'India','Turkey','Peru','Iran','Chile','Mexico','Saudi Arabia']
...
def animate(i):
	...
	plt.ylabel("New Confirmed Cases (in the Past Week)" , color = "Red") # labelling
	plt.xlabel("Total Confirmed Cases" , color = "Red")
	plt.title("Trajectory of COVID-19 Confirmed Cases", color = "Red")
