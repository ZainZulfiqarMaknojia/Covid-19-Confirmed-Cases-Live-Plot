...
CountriesName = ['US','United Kingdom','Italy','Brazil','France','Spain','Mexico','Belgium','Germany','Iran','Netherlands','India',
 				'Russia','Turkey','China']
data = []
x = []
y = []
...
def animate(i):
	...
	plt.ylabel("New Covid Deaths (in the Past Week)" , color = "Red") # labelling
	plt.xlabel("Total Covid Deaths" , color = "Red")
	plt.title("Trajectory of COVID-19 Deaths", color = "Red")
